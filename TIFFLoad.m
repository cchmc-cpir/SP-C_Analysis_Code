function [imag_vol, path, files] = TIFFLoad(start_path)
%% Reads in image slices that were exported as TIFF files from ImageJ
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
path = uigetdir('Select Exported TIFF Folder from ImageJ');
...
for indx = 1:num_files
    all_slices{indx} = imread(files(indx).name);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Generate 3D volume
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
